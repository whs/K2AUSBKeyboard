 ...
 * UK Layout By Owningle  23.06.2019
 */

public class UKQwertyLayout implements Layout {
    private HashMap<Character, KeyCode> keyTable;

    protected UKQwertyLayout() {
        ...
        keyMap.put((char)0x64, new char[]{'\\', '|', '\0'}); 	// Keyboard Non-US \ and |
