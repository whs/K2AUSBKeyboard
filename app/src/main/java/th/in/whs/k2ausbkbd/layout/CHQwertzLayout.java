...
public class CHQwertzLayout implements Layout {
    private HashMap<Character, KeyCode> keyTable;

    protected CHQwertzLayout() {
        ...
        keyMap.put((char)0x21, new char[]{'4', 'ç', '°'}); 	// Keyboard 4 and $
        keyMap.put((char)0x22, new char[]{'5', '%', '§'}); 	// Keyboard 5 and %
        keyMap.put((char)0x23, new char[]{'6', '&', '¬'}); 	// Keyboard 6 and ^
        ...
        keyMap.put((char)0x2d, new char[]{'\'', '?', '´' });
        keyMap.put((char)0x2e, new char[]{'^', '`', '~' });
        keyMap.put((char)0x2f, new char[]{'ü', 'è', '[' });
        keyMap.put((char)0x30, new char[]{'¨', '!', ']' });
        keyMap.put((char)0x31, new char[]{'$', '£', '}' });
        keyMap.put((char)0x32, new char[]{'$', '£', '}' });
        keyMap.put((char)0x33, new char[]{'ö', 'é', '\0' });
        keyMap.put((char)0x34, new char[]{'ä', 'à', '{' });
        keyMap.put((char)0x35, new char[]{'§', '°', '\0' });
        keyMap.put((char)0x36, new char[]{',', ';', '\0' });
        keyMap.put((char)0x37, new char[]{'.', ':', '\0' });
        keyMap.put((char)0x38, new char[]{'-', '_', '\0' });
